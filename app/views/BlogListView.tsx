    ...
    <LangFilter lang={lang}>
      ...
      <section className="cases-hero">
        <div className="wrap">
          ...
          <h1>
            <span data-uz>
              Maqolalar: <span className="hl">SEO, Google Ads, sayt</span>
            </span>
            <span data-ru>
              Статьи: <span className="hl">SEO, Google Ads, сайт</span>
            </span>
          </h1>
          <p className="lead" style={{ maxWidth: 720, margin: "0 auto" }}>
            <span data-uz>
              Amaliy bilim — bizning loyihalarimiz tajribasidan. Hech qanday
              «suv», faqat ishlatish mumkin bo‘lgan narsalar.
            </span>
            <span data-ru>
              Прикладные знания из опыта наших проектов. Без воды, только то,
              что работает.
            </span>
          </p>
        </div>
          ...
          <div className="blog-grid">
            {ARTICLES.map((p) => (
              ...
              >
                ...
                <h3>
                  <span data-uz>{p.titleUz}</span>
                  <span data-ru>{p.titleRu}</span>
                </h3>
                <p>
                  <span data-uz>{p.leadUz}</span>
                  <span data-ru>{p.leadRu}</span>
                </p>
                <div className="lnk">
                  <span data-uz>O‘qish →</span>
                  <span data-ru>Читать →</span>
                </div>
              </a>
            ))}
          </div>
      ...
      <section className="bg-soft-to-w" style={{ paddingBottom: 120 }}>
        <div className="wrap" style={{ maxWidth: 760 }}>
          <div className="form-block">
            ...
            <LeadForm source="blog" lang={lang} />
          </div>
          <div
            style={{
              marginTop: 18,
