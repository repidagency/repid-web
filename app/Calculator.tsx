...
import { Lang as LangFilter } from "./i18n";
                ...
                {capped && (
                  <div className="calc-cap-warn">
                    ...
                    <span data-ru>
                      ...
                      ёмкостью рынка (~{fmtNum(marketCap)}/мес). Добавочный
                      бюджет не сработает.
                    </span>
                  </div>
                )}
            ...
            <div className="ca-text">
              ...
              <p>
                <span data-uz>
                  ...
                  so‘rovlari, raqobatchilar va real prognoz bo‘yicha sizga
                  shaxsiy plan tayyorlaymiz.
                </span>
                <span data-ru>
