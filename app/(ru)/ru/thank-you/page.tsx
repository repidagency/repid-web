...
export const metadata: Metadata = {
  ...pageMetadata({
    lang: "ru",
    path: "/ru/thank-you",
    title: "Спасибо! Ваша заявка принята — Repid Agency",
  ...
  return (
    <main style={styles.page}>
      ...
      <div style={styles.card}>
        ...
        {/* Заголовок и текст */}
        <h1 style={styles.title}>Ваша заявка принята!</h1>
        <p style={styles.desc}>
          Спасибо за обращение. Наши специалисты изучат ваш проект и{" "}
          <span style={styles.timeBadge}>свяжутся в течение 15 минут</span>.
        </p>
        ...
        <div style={styles.statusWidget}>
          <div style={styles.statusStep}>
            ...
            <span style={styles.stepTextDone}>Получено</span>
          </div>
          <div style={styles.stepLine} />
          <div style={styles.statusStep}>
            <span style={styles.stepDotActive} />
            <span style={styles.stepTextActive}>В обработке</span>
          </div>
        </div>

        {/* Кнопка возврата */}
        <Link href="/ru" style={styles.button}>
          <svg
